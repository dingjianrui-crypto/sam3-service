...
| `include_body_motion` | boolean | `false` | Draw the upper-body skeleton, bilateral elbow/shoulder angles, and signed torso lean; Canoe jobs also show bilateral knee angles. Returns `BODY_MOTION_UNAVAILABLE` when completed pose results are absent |
